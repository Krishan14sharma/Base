...
public class FloatLabeledEditText extends LinearLayout {
    ...
    private void initialize() {
        ...
        editText.setHintTextColor(hintColor != null ? hintColor : ColorStateList.valueOf(Color.BLACK));// added to make the hint color
    ...
    private TextWatcher onTextChanged = new TextWatcher() {
        ...
        public void afterTextChanged(Editable editable) {
            ...
            setShowHint(editable.length() != 0);// fires everty time length is not 0
        }
    };
